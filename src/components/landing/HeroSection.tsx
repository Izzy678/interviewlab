...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden border-b border-border/70 pb-20 pt-12 sm:pb-28 sm:pt-20 lg:pb-32 lg:pt-24">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr] lg:gap-14 lg:px-12">
        <div className="max-w-xl animate-fade-up">
          <p className="mb-6 text-[11px] font-semibold uppercase tracking-[0.2em] text-primary">
            Your private interview studio
          </p>
          <h1 className="font-display text-balance text-[3.35rem] leading-[0.95] tracking-[-0.045em] sm:text-7xl lg:text-[5.3rem]">
          ...
          <p className="mt-7 max-w-lg text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">
            ...
            experience and the role you want. Leave knowing what to sharpen.
          </p>
        ...
        <div className="relative mx-auto w-full max-w-2xl animate-fade-up [animation-delay:180ms]">
          <div className="absolute -inset-8 -z-10 rounded-full bg-primary/[0.06] blur-3xl" />
          <div className="studio-shadow overflow-hidden rounded-[1.75rem] border border-border/80 bg-card/90 backdrop-blur-xl">
            ...
            <div className="grid min-h-[31rem] sm:grid-cols-[0.78fr_1.22fr]">
          ...
          <p className="mt-4 text-center text-[10px] uppercase tracking-[0.18em] text-muted-foreground">
            A preview of your live interview workspace
          </p>
        </div>
      </div>
    </section>
